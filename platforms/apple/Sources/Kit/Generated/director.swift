...
public struct FfiConverterTypeNarrationMode: FfiConverterRustBuffer {
    typealias SwiftType = NarrationMode

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NarrationMode {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        
        case 1: return .solo
        
        case 2: return .fullCast
        
        default: throw UniffiInternalError.unexpectedEnumCase
        }
    }

    public static func write(_ value: NarrationMode, into buf: inout [UInt8]) {
        switch value {
...
public func FfiConverterTypeNarrationMode_lift(_ buf: RustBuffer) throws -> NarrationMode {
    return try FfiConverterTypeNarrationMode.lift(buf)
}

public func FfiConverterTypeNarrationMode_lower(_ value: NarrationMode) -> RustBuffer {
    return FfiConverterTypeNarrationMode.lower(value)
}
